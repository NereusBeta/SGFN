...
def construct_cell_type_matrix(adata_sc,celltype_key):
    label = celltype_key
...
def project_cell_to_spot(adata, adata_sc,celltype_key, retain_percent=0.1):
    '''\
    ...
    matrix_cell_type = construct_cell_type_matrix(adata_sc,celltype_key)
    ...
    # rename cell types
    cell_type = list(adata_sc.obs[celltype_key].unique())
    cell_type = [str(s) for s in cell_type]
    cell_type.sort()
